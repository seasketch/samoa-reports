...
export async function ousConflictAreaOverlap(
...
export default new GeoprocessingHandler(ousConflictAreaOverlap, {
  title: "ousConflictAreaOverlap",
  description: "Calculate sketch overlap with ous conflict polygons",
  executionMode: "async",
  memory: 4096,
  timeout: 30,
  requiresProperties: [],
