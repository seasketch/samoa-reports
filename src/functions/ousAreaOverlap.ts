...
export async function ousAreaOverlap(
...
export default new GeoprocessingHandler(ousAreaOverlap, {
  title: "ousAreaOverlap",
  description: "Calculate sketch overlap with ous polygons",
  executionMode: "async",
  memory: 4096,
  timeout: 30,
  requiresProperties: [],
